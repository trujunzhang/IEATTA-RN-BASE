...
let t = require('tcomb-validation');
let bootstrap = {
  checkbox: function () {},
  datepicker: function () {},
  select: function () {},
...
let core = require('../lib/components');
...
test('Checkbox:hasError', function (tape) {
  ...
  let True = t.subtype(t.Boolean, function (value) { return value === true; });
...
let DatePicker = core.DatePicker;
let date = new Date(1973, 10, 30);
